...
<html lang="en-US">
    ...
    <head>
        ...
        <link href="favicon.png" rel="shortcut icon" type="logo_teko/png">
        ...
        <div class="wrapper">
            <ul class="scene unselectable" data-friction-x="0.1" data-friction-y="0.1" data-scalar-x="25" data-scalar-y="15" id="scene">
                ...
                <li class="layer" data-depth="0.25">
                    <div class="sphere">
                        <img alt="sphere" src="{{ asset('assets/images/logo_teko.png') }}">
                    </div>
                </li>
                ...
                <li class="layer" data-depth="0.30">
                    <div class="hero">
                        <h1 id="countdown">
                            Harapan untuk menunggu kehadirannya.
                        </h1>
                ...
                <li class="layer" data-depth="0.40">
                    <div class="depth-1 flake1">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth1/flakes1.png') }}">
                    </div>

                    <div class="depth-1 flake2">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth1/flakes2.png') }}">
                    </div>

                    <div class="depth-1 flake3">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth1/flakes3.png') }}">
                    </div>

                    <div class="depth-1 flake4">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth1/flakes4.png') }}">
                    </div>
                </li>

                <li class="layer" data-depth="0.50">
                    <div class="depth-2 flake1">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth2/flakes1.png') }}">
                    </div>

                    <div class="depth-2 flake2">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth2/flakes2.png') }}">
                    </div>
                </li>

                <li class="layer" data-depth="0.60">
                    <div class="depth-3 flake1">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth3/flakes1.png') }}">
                    </div>

                    <div class="depth-3 flake2">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth3/flakes2.png') }}">
                    </div>

                    <div class="depth-3 flake3">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth3/flakes3.png') }}">
                    </div>

                    <div class="depth-3 flake4">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth3/flakes4.png') }}">
                    </div>
                </li>

                <li class="layer" data-depth="0.80">
                    <div class="depth-4">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth4/flakes.png') }}">
                    </div>
                </li>

                <li class="layer" data-depth="1.00">
                    <div class="depth-5">
                        <img alt="flake" src="{{ asset('assets/images/flakes/depth5/flakes.png') }}">
                    </div>
                </li>
                <!-- Contact -->
                ...
                <li class="layer" data-depth="0.20">
                    <div class="contact">
                        <ul class="icons">
                            ...
                            <!--<li>
                                <a class="tiktok" href="#"><i class="fa fa-dribbble"></i></a>
                            </li>
                        </ul>
