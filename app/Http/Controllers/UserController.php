...
class UserController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            // Just get user mobile
            if(Auth::user()->role_id == 3) {
                $query->whereIn('role_id', [6, 7]);
            }
    ...
    public function approve(Request $request)
    {
        ...
        $usr->status = "Approve";
        $usr->status_id = 2;
        $usr->approval_at = Carbon::now();
        $usr->approval_by = Auth::user()->id;
        $usr->save();
    ...
    public function reject(Request $request)
    {
        ...
        $usr->status = "Reject";
        $usr->status_id = 3;
        $usr->rejected_at = Carbon::now();
        $usr->rejected_by = Auth::user()->id;
        $usr->save();
